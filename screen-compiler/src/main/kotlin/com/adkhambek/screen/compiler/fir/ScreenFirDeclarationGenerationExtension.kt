...
import com.adkhambek.compiler.common.ScreenArgs
import com.adkhambek.compiler.common.readScreenArgs
...
class ScreenFirDeclarationGenerationExtension(
    ...
    override fun generateProperties(
        ...
        if (name == "arg") {
            ...
            val componentUIArgs = owner.readScreenArgs(session)
    ...
    override fun generateFunctions(
        ...
        val componentUIArgs = outerSymbol.readScreenArgs(session)
        ...
        val fn = createMemberFunction(
            ...
            val argId = componentUIArgs.argClassId
            if (argId != null) {
                val argType = argId.createConeType(
                    session,
