...
// Import MessageCollector for forwarding to the IR transformer for diagnostic reporting.
...
class ScreenIrGenerationExtension(
    ...
    override fun generate(moduleFragment: IrModuleFragment, pluginContext: IrPluginContext) {
        ...
        moduleFragment.transformChildrenVoid(ScreenIrElementTransformer(pluginContext, messageCollector))
    }
}
